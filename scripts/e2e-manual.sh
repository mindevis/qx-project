...
echo "  5. QXLauncher receives launch-request; JVM starts (or QX_LAUNCH_DRY_RUN=1)"
echo ""
echo "--- Flow B (guest) ---"
...
echo "  Dev VPS: make dev-vps-up (SSH localhost:2222)"
echo "  .env API: QX_PUBLIC_API_URL=http://host.docker.internal:3000"
echo "  1. Servers - add VPS (SSH) - Deploy agent"
...
echo ""
echo "Dev shortcuts:"
echo "  QX_SKIP_TRAY=1          - console-only QXLauncher"
