...
func NewRouter(db *gorm.DB, authSvc *auth.Service, corsOrigin, sshMasterKey string, deployCfg DeploySettings, mojangCfg MojangSettings, modsCfg ModsSettings, cosmeticsCfg CosmeticsSettings, launcherCfg LauncherSettings) *gin.Engine {
	...
	v1 := r.Group("/api/v1")
	{
		...
		authed.Use(AuthMiddleware(tokens))
		{
			...
			authed.PATCH("/servers/:id/game-servers/:gameServerId/mods", gameServersH.SetModEnabled)
			...
			authed.PATCH("/servers/:id/game-servers/:gameServerId/resourcepacks", gameServersH.SetResourcepackEnabled)
			...
			authed.PATCH("/servers/:id/game-servers/:gameServerId/shaders", gameServersH.SetShaderEnabled)
			...
			authed.PATCH("/servers/:id/game-servers/:gameServerId/plugins", gameServersH.SetPluginEnabled)
			...
			authed.PATCH("/servers/:id/game-servers/:gameServerId/datapacks", gameServersH.SetDatapackEnabled)
