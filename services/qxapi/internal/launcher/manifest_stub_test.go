...
func (s stubManifestProvider) BuildInstanceManifest(_ context.Context, instanceID, name, mcVersion, loader, loaderVersion, _ string) (*mcmanifest.InstanceLaunchManifest, error) {
	if s.err != nil {
		return nil, s.err
	}
	if s.manifest != nil {
