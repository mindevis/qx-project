...
kv MINIO_ENDPOINT "${MINIO_ENDPOINT:-minio:9000}"
kv MINIO_BUCKET "${MINIO_BUCKET:-qx}"
kv MINIO_ACCESS_KEY "${MINIO_ROOT_USER:-minio}"
kv MINIO_SECRET_KEY "$PROD_MINIO_PASSWORD"
kv MINIO_USE_SSL "${MINIO_USE_SSL:-false}"
