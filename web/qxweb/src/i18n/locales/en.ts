...
export const en: Messages = {
  ...
  skins: {
    ...
    title: 'Skins',
    subtitle:
      'Your Microsoft-account skin shows first — including one set through CurseForge or minecraft.net. Then pick another from the catalog or upload a PNG.',
    catalog: {
      sectionTitle: 'Skin catalog',
      sectionLead:
        'Ready-made skins from public Mojang profiles. Select copies the skin into QX and applies it in the launcher.',
    ...
    equip: {
      sectionTitle: 'Current skin',
      sectionLead: 'The preview uses your licensed account until you upload or pick a different skin here.',
    },
  ...
  cosmetics: {
    ...
    skinApplied: 'QX skin',
    skinOfficial: 'Microsoft skin',
    skinDefault: 'Default skin',
    skinOfficialHint:
      'This is the skin on your licensed account — including one you set through CurseForge or minecraft.net.',
    mojangNotLinked: 'Link Microsoft to see your real Minecraft skin.',
    goToProfile: 'Open profile',
    importOfficialSkin: 'Copy Microsoft skin into QX',
    skinImported: 'Microsoft skin copied into QX',
    importFailed: 'Failed to copy the Microsoft skin',
    uploadSkin: 'Upload skin (PNG)',
    resetSkin: 'Reset skin',
    resetSkinConfirm: 'Reset the skin to the default one?',
    resetSkinConfirmOfficial: 'Reset the QX skin and show your Microsoft account skin again?',
    cape: 'Cape',
    capeNone: 'None',
    capeQX: 'QX cape',
    capeCustom: 'Custom',
  ...
  servers: {
    ...
    networkDiagramLobbyHint: 'Drag a card into “join (try)” — that is where players land from the proxy.',
    ...
    networkOverwriteTitle: 'The proxy config already has settings',
    networkOverwriteHint:
      'New servers can be added right away. Existing Velocity values change only if you confirm:',
    networkOverwriteConfirm: 'Replace in config',
    networkOverwriteKeep: 'Keep existing',
    networkOverwriteMerged: 'New entries were added. The rest of the config was left unchanged.',
    networkChangeBind: 'bind',
    networkChangeMotd: 'motd',
    networkChangeTry: 'join (try)',
    networkChangeSecret: 'forwarding.secret',
    networkChangeServer: '{{name}}',
    networkChangeRemove: 'remove {{name}}',
    networkChangeLine: '{{field}}: {{from}} → {{to}}',
    networkChangeLineRemove: '{{field}} ({{from}})',
    networkDiagramTry: 'join (try)',
    networkDiagramConnect: 'proxy',
    networkBoardWorlds: 'Game worlds',
    networkBoardEmptyProxy: 'Add a proxy',
    networkBoardDropHere: 'Drop a card here',
    ...
    ollamaModelsEmptyHint: 'Enter a model name such as qwen2.5:1.5b or llama3.2, then click Download.',
    ...
    mysqlUninstall: 'Reset',
    mysqlUninstallConfirm: 'Remove MySQL from this server? Databases and users in the panel will be cleared so you can install again.',
    mysqlUninstalled: 'MySQL removed',
    mysqlStart: 'Start',
    mysqlStop: 'Stop',
  ...
  gameServerDetail: {
    ...
    content: {
      ...
      setEnabledCompleted: 'Enabled on the server',
      setDisabledCompleted: 'Disabled on the server',
      setEnabledFailed: 'Could not change enabled state',
      versionUpdated: 'Version replaced on the server',
      changeVersionAria: 'Version of {{name}}',
      folder: 'Folder',
