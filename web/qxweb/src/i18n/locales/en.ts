...
export const en: Messages = {
  ...
  servers: {
    ...
    gameServerTypeHint: {
      ...
      velocity: 'Velocity — proxy: players connect here, then move to lobby and game servers.',
    },
    ...
    gameServerProxyVersion: 'Velocity version',
    ...
    gameServerProxyVersionRequired: 'Select a Velocity version',
    ...
    networksHint:
      'Group Velocity, lobby, and game worlds. The diagram shows how players join through the proxy and move between servers.',
    networksEmpty: 'No projects yet',
    networksEmptyHint: 'Create a project, add Velocity and a lobby — the diagram will show the arrows.',
    ...
    networkAlias: 'Velocity name',
    networkAliasHint: 'Used in /server — for example lobby, survival.',
    networkApply: 'Write Velocity config',
    networkApplied: 'Velocity config updated. Restart the proxy if it is already running.',
    networkApplyOffline: 'Diagram saved. When the agent is online, click “Write Velocity config”.',
    networkApplyPartial: 'Diagram saved, but Velocity config could not be updated: {{error}}',
    networkDiagramPlayers: 'Players',
    networkDiagramTry: 'join (try)',
    networkDiagramConnect: 'proxy',
    networkDiagramTransfer: 'transfer /server',
    networkNeedProxy: 'Add Velocity — that is the player entry point.',
    ollamaTitle: 'Ollama',
    ollamaHint:
  ...
  gameServerDetail: {
    ...
    versionTitleProxy: 'Velocity version',
    versionHint:
    ...
    versionHintProxy:
      'Changing the Velocity version reinstalls the proxy core. Project server mappings are written again after install.',
