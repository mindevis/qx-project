export const ru = {
  ...
  servers: {
    ...
    gameServerTypeHint: {
      ...
      velocity: 'Velocity — прокси: игроки заходят сюда, а дальше переходят на lobby и игровые серверы.',
    },
    ...
    gameServerProxyVersion: 'Версия Velocity',
    ...
    gameServerProxyVersionRequired: 'Выберите версию Velocity',
    ...
    networksHint:
      'Объедините Velocity, lobby и игровые миры. Схема показывает, как игроки заходят через прокси и переходят между серверами.',
    networksEmpty: 'Пока нет проектов',
    networksEmptyHint: 'Создайте проект, добавьте Velocity и lobby — схема появится со стрелками.',
    ...
    networkAlias: 'Имя в Velocity',
    networkAliasHint: 'Так сервер называется в /server — например lobby, survival.',
    networkApply: 'Прописать в Velocity',
    networkApplied: 'Конфиг Velocity обновлён. Перезапустите прокси, если он уже запущен.',
    networkApplyOffline: 'Схема сохранена. Когда агент будет онлайн, нажмите «Прописать в Velocity».',
    networkApplyPartial: 'Схема сохранена, но конфиг Velocity не удалось обновить: {{error}}',
    networkDiagramPlayers: 'Игроки',
    networkDiagramTry: 'вход (try)',
    networkDiagramConnect: 'прокси',
    networkDiagramTransfer: 'перевод /server',
    networkNeedProxy: 'Добавьте Velocity — это точка входа для игроков.',
    ollamaTitle: 'Ollama',
    ollamaHint:
  ...
  gameServerDetail: {
    ...
    versionTitleProxy: 'Версия Velocity',
    versionHint:
    ...
    versionHintProxy:
      'Смена версии Velocity переустановит ядро прокси. Список серверов в проекте будет прописан заново после установки.',
